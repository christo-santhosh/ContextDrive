...
class YOLO {
  ...
  /// On iOS, this enables hardware-accelerated inference: Core ML on the Neural Engine + CPU (iOS 16+), or an opt-in
  /// Core AI `.aimodel` across the Neural Engine, GPU and CPU (iOS 27+); when false, inference is pinned to CPU only.
  ///
